...
class Fora_Admin {
	...
	public function admin_menu() {
		...
		$page = add_theme_page( esc_html__( 'About', 'fora' ) . ' ' . $theme->display( 'Name' ), esc_html__( 'About', 'fora' ) . ' ' . $theme->display( 'Name' ), 'activate_plugins', 'fora-welcome', array( $this, 'welcome_screen' ) );
	...
	public static function hide_notices() {
		if ( isset( $_GET['fora-hide-notice'] ) && isset( $_GET['_fora_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_fora_notice_nonce'], 'fora_hide_notices_nonce' ) ) {
	...
	private function intro() {
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'fora_pro_theme_url', 'http://crestaproject.com/demo/fora/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'fora' ); ?></a>

					<a href="<?php echo esc_url( apply_filters( 'fora_pro_theme_url', 'http://crestaproject.com/demo/fora-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'fora' ); ?></a>
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'fora-welcome' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'fora-welcome' ), 'themes.php' ) ) ); ?>">
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							<a href="<?php echo esc_url( apply_filters( 'fora_pro_theme_url', 'http://crestaproject.com/demo/fora-pro/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View PRO version demo', 'fora' ); ?></a>
